...
import edu.asu.bsenetza.crud.gradebook.bsenetzasrv.jaxb.model.Grade;
import edu.asu.bsenetza.crud.gradebook.bsenetzasrv.jaxb.model.GradedItem;
import edu.asu.bsenetza.crud.gradebook.bsenetzasrv.jaxb.utils.Converter;
...
public class GradeResource {
    ...
    public Response createGrade(@PathParam("gradedItemId") int gradedItemId, @PathParam("studentId") int studentId, String content) {
        ...
        if (grade == null) {
            ...
            LOG.info("Creating a {} {} Status Response", Response.Status.CONFLICT.getStatusCode(), Response.Status.CONFLICT.getReasonPhrase());
            LOG.debug("Cannot create Grade Resource as values are already set to {}", grade);
